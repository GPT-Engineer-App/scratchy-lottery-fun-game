...
**Project**: scratchy-lottery-fun-game 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a lottery state scratch off web game 
...
```sh
git clone https://github.com/GPT-Engineer-App/scratchy-lottery-fun-game.git
cd scratchy-lottery-fun-game
npm i
